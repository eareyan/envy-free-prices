...
public class MarketFactory {
   ...
   */
  public static Market<Goods, Bidder<Goods>> cloneMarket(Market<Goods, Bidder<Goods>> market) throws BidderCreationException, GoodsCreationException,
  ...
  /**
   * Transpose market, i.e., interchange goods for bidders. This means: a good i with supply N_i becomes a bidder j with demand N_i and a new random reward. A
   * bidder j with demand I_j becomes a good i with supply I_j. The connections are preserved, i.e. if (i,j) is connected in the original market, then it will
   * be in the transposed market. This is to say, if bidder j demands good i, then good j will be demanded by bidder i in the new market.
   * 
   * @param market - a Market object
